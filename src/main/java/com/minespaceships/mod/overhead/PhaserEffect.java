...
public class PhaserEffect extends EntityWeatherEffect {
	...
	public PhaserEffect(World worldIn, double posX, double posY, double posZ) {
		super(worldIn);
    ...
    public void onUpdate()
    {
        ...
        if (this.lightningState >= 0)
        {
            ...
            else
            {
                ...
                EntityLightningBolt killer = new EntityLightningBolt(worldIn, x, y, z);
